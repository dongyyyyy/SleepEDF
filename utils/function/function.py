...
def get_dataset_selectChannel(signals_path,annotations_path,filename,select_channel=[0,1,2],use_noise=False,epsilon=0.5,noise_scale=2e-6,preprocessing=False,norm_methods='Standard'):
